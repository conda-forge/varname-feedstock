...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/varname-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14173&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/varname-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `varname` can be installed with:

```
conda install varname
```

It is possible to list all of the versions of `varname` available on your platform with:
